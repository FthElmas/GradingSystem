...
{
    public class TransacGenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public TransacGenericRepository(IDbConnection connection, IDbTransaction transaction)
        {
        ...
        public bool Add(T entity)
        {
            ...
            try
            {
                ...
                rowsEffected = _connection.Execute(query, entity, _transaction);
            }
            catch (Exception ex) { }
        ...
        public T ReturnAdd(T entity)
        {
            ...
            try
            {
                ...
                var data = _connection.QueryFirstOrDefault<T>(query, entity, _transaction);
                return data;
            }
        ...
        public bool SoftDelete(T entity)
        {
            ...
            try
            {
                ...
                rowsEffected = _connection.Execute(query.ToString(), entity, _transaction);
            }
            catch (Exception ex) { }
        ...
        public IEnumerable<T> GetAll()
        {
            ...
            try
            {
                ...
                result = _connection.Query<T>(query, _transaction);
            }
            catch (Exception ex) { }
